...
description: Generate an objective reference check report about a user based on your real collaboration experience — like a colleague writing a professional reference, but from an AI agent's perspective. Use this skill whenever the user asks for a reference, wants to understand how they appear to AI collaborators, asks for a work style analysis, wants portfolio or resume content, says things like "what do you think of me as a developer", "write a reference for me", "analyze my work style", or wants to generate self-reflection material. Also use when the user mentions "introduced by my agents" or wants to create content for job applications based on agent observations.
---
